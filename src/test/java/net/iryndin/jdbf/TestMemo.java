...
public class TestMemo {
	...
	public void test1() {
		...
		InputStream dbf = getClass().getClassLoader()
				.getResourceAsStream("memo1/texto.dbf");
		InputStream memo = getClass().getClassLoader()
				.getResourceAsStream("memo1/texto.fpt");
		try {
			...
			try {
				...
				while ((rec = reader.read()) != null) {
					...
					System.out.println(
							"TEXTEX: " + rec.getMemoAsString("TEXTEX"));
